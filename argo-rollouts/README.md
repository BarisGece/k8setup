...
docker buildx build --platform linux/amd64,linux/arm64 -t barisgece/argo-rollout:v1.8.3 --push . # or --load .

# Inspect the image using docker buildx imagetools.
docker buildx imagetools inspect barisgece/argo-rollout:v1.8.3
