...
ENV VERSION="${VERSION_DEFAULT:-0.1.21}"
# Note - Latest version of EKSCTL - https://github.com/weaveworks/eksctl/releases
ENV EKSCTL_VERSION="${EKSCTL_DEFAULT_VERSION:-0.129.0}"
...
ENV AWSCLI_VERSION="${AWSCLI_DEFAULT_VERSION:-2.9.22}"
...
ENV TERRAGRUNT_VERSION="${TERRAGRUNT_DEFAULT_VERSION:-0.43.2}"
